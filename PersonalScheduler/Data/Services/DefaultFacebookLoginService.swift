//
//  DefaultFacebookLoginService.swift
//  PersonalScheduler
//
...
final class DefaultFacebookLoginService: FacebookLoginService {
...
//    }
    ...
    func login() {
        loginManager.logIn(
            configuration: .init(permissions: Set(["public_profile","email"]))!) { _ in }
    }
